...
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationVS, TEXT("/Plugin/CustomShader/Private/MyShader.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationPS, TEXT("/Plugin/CustomShader/Private/MyShader.usf"), TEXT("MainPS"), SF_Pixel)
    ...
    ERHIFeatureLevel::Type FeatureLevel)
{
    ...
    RHICmdList.BeginRenderPass(RPInfo, TEXT("DrawUVDisplacement"));
    {
        ...
        RHICmdList.DrawPrimitive(PT_TriangleList, PrimitiveCount, 1);
    ...
    //RHICmdList.Transition(FRHITransitionInfo(OutTextureRenderTargetResource->GetRenderTargetTexture(), ERHIAccess::RTV, ERHIAccess::SRVMask));
}
